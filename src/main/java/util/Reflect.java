...
/**
 * Created by wanghongxiang on 15/10/1.
 */
...
//            puts(constructor);
    ...
    private static Constructor getRightConstructor(Class<?> classType, Object[] objects){
        ...
        for (Constructor constructor:classType.getConstructors()){
            ...
            for (Parameter parameter : constructor.getParameters()) {
                flagList.add(getFlag(linkList, parameter,flagList));
            }
    ...
    private static Boolean getFlag(LinkedList<Object> linkList, Parameter parameter, List<Boolean> flagList){
        boolean flag = false;
